...
$vote_from_user = $entityBody['vote_from'];
$vote_month = date('m');
...
if ($conn->connect_error) {
    ...
    $sql = "SELECT * FROM votes WHERE vote_from_user = '$vote_from_user' AND vote_month = '$vote_month'";
    $result = $conn->query($sql);
    if ($result->num_rows > 0) {
        echo "You have already submitted a vote this month.";
    } else {
        $sql = "INSERT INTO votes (vote_for, vote_from_user, vote_month) VALUES ('$vote_for', '$vote_from_user', '$vote_month')";
